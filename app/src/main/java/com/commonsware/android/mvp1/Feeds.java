...
public class Feeds {
    ...
    public Feeds[] feedItems = {
            new Feeds(this.titularUno,
                    this.contenidoUno,
                    this.videosUno
            ),
            new Feeds(this.titularDos,
                    this.contenidoDos,
                    this.videosDos
            ),
            new Feeds(this.titularTres,
                    this.contenidoTres,
                    this.videosTres
            ),
            new Feeds(this.titularCuatro,
                    this.contenidoCuatro,
                    this.videosCuatro
            ),
            new Feeds(this.titularCinco,
                    this.contenidoCinco,
                    this.videosCinco
            ),
            new Feeds(this.titularSeis,
                    this.contenidoSeis,
                    this.videosSeis
            ),
            new Feeds(this.titularSiete,
                    this.contenidoSiete,
                    this.videosSiete
            ),
            new Feeds(this.titularOcho,
                    this.contenidoOcho,
                    this.videosOcho
            ),
    ...
    public Feeds getItem(int id) {
        for (Feeds item : feedItems) {
            if (item.getId() == id) {
                return item;
            }
        }
